...
-- ============================================================
-- 2. STORAGE RLS: Only admins can read/list; counselors can
-- upload their own file during registration
-- ============================================================
CREATE OR REPLACE FUNCTION storage.obtener_usuario_id_archivo(nombre_archivo text)
RETURNS uuid
LANGUAGE plpgsql
AS $$
BEGIN
...
WITH CHECK (
  bucket_id = 'titulos'
  AND (storage.obtener_usuario_id_archivo(name) = auth.uid())
);
...
-- The signup trigger inserts the user profile (see section 7)
...
-- ============================================================
-- 5. RLS POLICIES — psicoorientadores
-- ============================================================
...
-- ============================================================
-- 8. RLS POLICIES — registros_emocionales
-- ============================================================
...
-- ============================================================
-- 11. CHECK CONSTRAINTS (non-breaking)
-- ============================================================
...
-- ============================================================
-- 12. NOT NULL CONSTRAINTS (non-breaking additions)
-- ============================================================
